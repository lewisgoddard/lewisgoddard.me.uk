...
?>
	...
	<section class="wide">
		...
		<div class="large-half align-center">
			...
			<h4>
				...
				<a class="button rounded source" href="https://github.com/eustasy/certbot-with-nginx"><i class="fa fa-code-fork"></i>&nbsp; Source</a>
			</h4>
		</div>
	</section>
	...
	<section id="improvements-to-security">
		...
		<ul>
			<li><a href="https://github.com/eustasy/certbot-with-nginx">eustasy/certbot-with-nginx</a> provides guides, scripts, and configurations for using free, automated SSL by <a href="https://letsencrypt.org/">Let's Ecrypt</a> to secure websites.
